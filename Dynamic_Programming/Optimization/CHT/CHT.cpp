/**
    Resource: https://rezwanarefin01.github.io/posts/convex-hull-trick/
...
void syntex_error()
{
    ...
    bool decSlop, minQuery;
    cin>>n>>a;
    if(a == 1) decSlop=1, minQuery=1;
    if(a == 2) decSlop=1, minQuery=0;
    if(a == 3) decSlop=0, minQuery=1;
    if(a == 4) decSlop=0, minQuery=0;

    CHT container = CHT(decSlop, minQuery);
